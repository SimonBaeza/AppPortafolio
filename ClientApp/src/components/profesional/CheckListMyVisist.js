...
export class CheckListMyVisit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formValues: {
      ...
      this.state.data.forEach(element => {
        if (element.run == this.state.formValues.run) {
          let dataToSet = {
            ...
            id_profesional: element.idProfessional,
            rut_company: element.idCompany,
  ...
  handleSubmit(event) {
    ...
    fetch(
      "http://localhost:51424/api/Visits/updateVisit/" +
  ...
  componentWillMount() {
    //event.preventDefault();
    fetch(
      "http://localhost:51424/api/Visits/getVisitsByProfesional/" +
      ...
      .then(json => {
        this.setState({
          ...
          formValues: {
            ...
            id_profesional: json[0].idProfessional,
            rut_company: json[0].idCompany,
                ...
                <Form onSubmit={this.handleSubmit.bind(this)}>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      ...
                      name="name"
                      id="name"
                      placeholder="Visita para revisar la Seguridad"
